        ...
        with self.strategy.scope():
            ...
            for epoch in epoch_bar:
                ...
                if self.test_dataset:
                    ...
                    print(f"epoch {epoch+1}: test loss {test_loss_metric.result():.5f}. test accuracy {test_accuracy.result():.5f}. test right accuracy {(total_right/countt):.5f}")
