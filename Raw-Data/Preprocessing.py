...
with open('/content/drive/MyDrive/EMOTION/VQVAE-trans/Trans-checkpoints-py/final_video_X_train_30.pkl',
          'wb') as filepath:
    pickle.dump(X_train, filepath)
with open('/content/drive/MyDrive/EMOTION/VQVAE-trans/Trans-checkpoints-py/labels_final_video_y_train_30.pkl',
          'wb') as filepath:
    pickle.dump(y_train, filepath)
with open('/content/drive/MyDrive/EMOTION/VQVAE-trans/Trans-checkpoints-py/final_video_X_test_30.pkl',
          'wb') as filepath:
    pickle.dump(X_test, filepath)
with open('/content/drive/MyDrive/EMOTION/VQVAE-trans/Trans-checkpoints-py/labels_final_video_y_test_30.pkl',
          'wb') as filepath:
